package Tugas_Pemrograman_lanjut_SI_B.Tugas_Bab4_Modul_Enscapsulation.Tugas_Praktikum;

public class CekSwalayan {

        public static void main(String[] args) {
                Swalayan t1 = new Swalayan("Bintang Ramdhan",
                                "Silver");
                System.out.println(" PELANGGAN 0023");
                System.out.println("--------------------------------------------------------------------");
                System.out.println("Nama: " + t1.getNama());
                System.out.println("Jenis Rekening: " +
                                t1.getjenisRekening());
                t1.setnomorPelanggan("347738");
                t1.setPin("1234");
                System.out.println("--------------------------------------------------------------------");
                t1.autentifikasi("347738", "1234");
                t1.topUp(300000);
                t1.setPembelian(50000);
                System.out.println("\n");
                Swalayan t2 = new Swalayan("adi susanto",
                                "Gold");
                ...
                System.out.println("\n");
                Swalayan t3 = new Swalayan("Satria",
                                "Platinum");
